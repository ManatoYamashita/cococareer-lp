...
const footer = () => {
    return (
        ...
        <div className="bg-midnightyellow">
            ...
            <div className="mx-auto max-w-2xl pt-4 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                <div className="my-12 grid grid-cols-1 gap-y-10 sm:grid-cols-6 lg:grid-cols-12">
                    ...
                    <div className='sm:col-span-6 lg:col-span-3'>
                        <div className="flex flex-shrink-0 items-center border-right">
                            <Image src="/assets/footer/cococareer-logo-revert.png" alt="cococareer-logo-revert" width={214} height={66} />
                        </div>
                    </div>
                ...
                <div className='pt-12 pb-10 lg:flex items-center justify-between border-t border-t-white border-opacity-30'>
                    <h4 className='text-lg text-center md:text-start font-normal text-white opacity-60'>@2025. cocomotion/cococareer. All rights reserved</h4>
                    <div className="flex gap-5 mt-6 md:mt-0 justify-center md:justify-start">
                        ...
                        <h4 className='opacity-60 text-lg font-normal text-white'><Link href="https://manapuraza.com" target="_blank">Web Design / ManatoYamashita</Link></h4>
                    </div>
                </div>
            </div>
        </div >
